...
export function PersonajeCard({ personaje }: personajesChardProps) {
  ...
  console.log('Contexto:', { agregarPersonajeFavorito, removerPersonajeFavorito, verificarexistenciaPersonaje })

  if (!agregarPersonajeFavorito || !removerPersonajeFavorito || !verificarexistenciaPersonaje) {
