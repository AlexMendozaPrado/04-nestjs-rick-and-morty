...
export function BotonFavorito(){
    ...
    return (
        <Link href='/favoritos' passHref>
            <a className="flex items-center relative rounded-full border-none bg-blue-500 text-gray-900 text-md p-3 cursor-pointer transition-opacity duration-200 hover:opacity-80">
                <AiFillStar />
                {cantidadFavoritos > 0 && (
